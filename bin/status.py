class Status:
    ...
    BACKUP_ANALYSIS_HALT_REQUESTED = 0x12
    BACKUP_READY_FOR_ANALYSIS = 0x13
    BACKUP_READY_FOR_BACKUP = 0x14
    BACKUP_BACKUP_RUNNING = 0x15
    BACKUP_HALT_REQUESTED = 0x16
    VERIFICATION_RUNNING = 0x17
    ...
    # 0x4 => Backup operation
    BACKUP_IDLE = 0x40
    BACKUP_ANALYSIS_RUNNING = 0x41
    BACKUP_ANALYSIS_FINISHED = 0x42
    BACKUP_ANALYSIS_ABORTED = 0x43
    BACKUP_BACKUP_RUNNING = 0x44
    BACKUP_BACKUP_FINISHED = 0x45
    BACKUP_BACKUP_ABORTED = 0x46
    ...
    UPDATEUI_CURRENT_FILE_DETAILS = 0xe7
